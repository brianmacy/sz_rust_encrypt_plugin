...
use crate::utils::{add_encryption_prefix, has_encryption_prefix, remove_encryption_prefix, SIGNATURE_DUMMY};
...
impl EncryptionProvider for DummyEncryption {
    fn init(&mut self) -> Result<()> {
        ...
        self.key = SIGNATURE_DUMMY.as_bytes().to_vec();
        Ok(())
    }
...
mod tests {
    ...
    fn test_signature_validation() {
        ...
        assert!(encryption.validate_signature(SIGNATURE_DUMMY).is_ok());
