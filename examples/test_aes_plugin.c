...
// Function declarations for the AES plugin
...
int test_plugin_lifecycle() {
    printf("🔧 Testing AES Plugin Lifecycle...\n");
...
int test_encryption_operations() {
    printf("\n🔐 Testing AES Encryption Operations...\n");
    ...
    for (int i = 0; i < 5; i++) {
        ...
        printf("✅ Deterministic encrypted (length %zu)\n", det_encrypted_size - 1);
...
int main() {
    printf("🧪 AES Plugin Test Suite\n");
    printf("========================\n");

    // Set environment variables for testing
    setenv("SZ_AES_KEY", "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", 1);
    setenv("SZ_AES_IV", "0123456789abcdef0123456789abcdef", 1);

    printf("🔑 Environment variables set:\n");
    printf("   SZ_AES_KEY=0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\n");
    printf("   SZ_AES_IV=0123456789abcdef0123456789abcdef\n\n");
