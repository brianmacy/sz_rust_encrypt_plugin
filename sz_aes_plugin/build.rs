...
fn main() {
    ...
    // Create the header file manually for AES plugin
    let header_content = r#"/* Senzing AES Encryption Plugin - Rust Implementation */
...
"#;
    ...
    fs::write("include/sz_aes_encrypt_plugin.h", header_content)
