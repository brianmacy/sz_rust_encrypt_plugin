...
fn main() {
    ...
    // Create the header file manually since cbindgen has issues with Rust 2024
    let header_content = r#"/* Senzing Encryption Plugin - Rust Implementation */
...
"#;
    ...
    fs::write("include/sz_encrypt_plugin.h", header_content)
