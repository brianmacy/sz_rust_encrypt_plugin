...
fn main() {
    ...
    // Create the header file manually for Dummy plugin
    let header_content = r#"/* Senzing Dummy Encryption Plugin - Rust Implementation */
#ifndef SZ_DUMMY_ENCRYPT_PLUGIN_H
#define SZ_DUMMY_ENCRYPT_PLUGIN_H
...
#endif /* SZ_DUMMY_ENCRYPT_PLUGIN_H */
"#;

    fs::write("include/sz_dummy_encrypt_plugin.h", header_content)
